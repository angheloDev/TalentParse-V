...
export type UploadedResumeDocument = InferSchemaType<
	typeof UploadedResumeSchema
>;
export type UserProfileDocument = InferSchemaType<typeof UserProfileSchema>;
export type SavedJobAnalysisDocument = InferSchemaType<
	typeof SavedJobAnalysisSchema
>;

export const UploadedResumeModel =
	mongoose.models.UploadedResume ||
	mongoose.model<UploadedResumeDocument>(
		'UploadedResume',
...
export const SavedJobAnalysisModel =
	...
	mongoose.model<SavedJobAnalysisDocument>(
		'SavedJobAnalysis',
		SavedJobAnalysisSchema,
	);
